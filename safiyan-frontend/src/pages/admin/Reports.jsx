  ...
  return (
    <div>
      <div style={headerStyle}>
        ...
        <button onClick={() => window.print()} style={buttonStyle}>Print</button>
      </div>
...
const titleStyle = { fontSize: 28, fontWeight: 800, color: '#0f4c81' };
...
const lineStyle = { display: 'flex', justifyContent: 'space-between', padding: '10px 0', color: '#334155' };
